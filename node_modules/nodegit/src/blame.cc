...
// start convert_from_v8 block
  ...
  Nan::Utf8String buffer(Nan::To<v8::String>(info[0]).ToLocalChecked());
...
// start convert_from_v8 block
  size_t from_buffer_len;
      from_buffer_len = (size_t)   info[1].As<v8::Number>()->Value();
// end convert_from_v8 block
  ...
  BufferWorker *worker = new BufferWorker(baton, callback);
        ...
        if (!info[0]->IsUndefined() && !info[0]->IsNull())
          worker->SaveToPersistent("buffer", Nan::To<v8::Object>(info[0]).ToLocalChecked());
        if (!info[1]->IsUndefined() && !info[1]->IsNull())
          worker->SaveToPersistent("buffer_len", Nan::To<v8::Object>(info[1]).ToLocalChecked());
...
// start convert_to_v8 block
    if (baton->out != NULL) {
      v8::Local<v8::Array> owners = Nan::New<Array>(0);
            Nan::Set(owners, Nan::New<v8::Number>(owners->Length()), Nan::To<v8::Object>(this->GetFromPersistent("reference")).ToLocalChecked());
             to = GitBlame::New(
        baton->out,
        true
          , owners
  ...
  // end convert_to_v8 block
    ...
    if (baton->error) {
      ...
      if (baton->error->message) {
        ...
        err = Nan::To<v8::Object>(Nan::Error("Method buffer has thrown an error.")).ToLocalChecked();
      }
      Nan::Set(err, Nan::New("errno").ToLocalChecked(), Nan::New(baton->error_code));
      Nan::Set(err, Nan::New("errorFunction").ToLocalChecked(), Nan::New("Blame.buffer").ToLocalChecked());
      ...
      if (!callbackFired) {
        v8::Local<v8::Object> err = Nan::To<v8::Object>(Nan::Error("Method buffer has thrown an error.")).ToLocalChecked();
        Nan::Set(err, Nan::New("errno").ToLocalChecked(), Nan::New(baton->error_code));
        Nan::Set(err, Nan::New("errorFunction").ToLocalChecked(), Nan::New("Blame.buffer").ToLocalChecked());
        v8::Local<v8::Value> argv[1] = {
          err
...
// start convert_from_v8 block
  git_blame_options * from_options = NULL;
    if (info[2]->IsObject()) {
from_options = Nan::ObjectWrap::Unwrap<GitBlameOptions>(Nan::To<v8::Object>(info[2]).ToLocalChecked())->GetValue();
  }
  else {
    from_options = 0;
  }
...
// start convert_to_v8 block
  ...
  // end convert_to_v8 block
    ...
    if (baton->error) {
      ...
      Nan::Set(err, Nan::New("errno").ToLocalChecked(), Nan::New(baton->error_code));
      Nan::Set(err, Nan::New("errorFunction").ToLocalChecked(), Nan::New("Blame.file").ToLocalChecked());
      v8::Local<v8::Value> argv[1] = {
        err
      };
      callback->Call(1, argv, async_resource);
...
// start convert_from_v8 block
  uint32_t from_index;
      from_index = (uint32_t)   info[0].As<v8::Number>()->Value();
// end convert_from_v8 block
...
// start convert_from_v8 block
  size_t from_lineno;
      from_lineno = (size_t)   info[0].As<v8::Number>()->Value();
// end convert_from_v8 block
