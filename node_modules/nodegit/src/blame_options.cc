...
GitBlameOptions::~GitBlameOptions() {
                   this->newest_commit.Reset();
             this->oldest_commit.Reset();
          }

void GitBlameOptions::ConstructFields() {
                   v8::Local<Object> newest_commitTemp = Nan::To<v8::Object>(GitOid::New(
&this->raw->newest_commit,
            false
          )).ToLocalChecked();
          this->newest_commit.Reset(newest_commitTemp);

             v8::Local<Object> oldest_commitTemp = Nan::To<v8::Object>(GitOid::New(
  ...
  Nan::Set(target, Nan::New("BlameOptions").ToLocalChecked(), _constructor_template);
    ...
    NAN_SETTER(GitBlameOptions::SetNewestCommit) {
      GitBlameOptions *wrapper = Nan::ObjectWrap::Unwrap<GitBlameOptions>(info.This());
        ...
        v8::Local<Object> newest_commit(Nan::To<v8::Object>(value).ToLocalChecked());

        wrapper->newest_commit.Reset(newest_commit);

        wrapper->raw->newest_commit = *  Nan::ObjectWrap::Unwrap<GitOid>(Nan::To<v8::Object>(newest_commit).ToLocalChecked())->GetValue() ;
    ...
    NAN_SETTER(GitBlameOptions::SetOldestCommit) {
      GitBlameOptions *wrapper = Nan::ObjectWrap::Unwrap<GitBlameOptions>(info.This());
        ...
        v8::Local<Object> oldest_commit(Nan::To<v8::Object>(value).ToLocalChecked());

        wrapper->oldest_commit.Reset(oldest_commit);

        wrapper->raw->oldest_commit = *  Nan::ObjectWrap::Unwrap<GitOid>(Nan::To<v8::Object>(oldest_commit).ToLocalChecked())->GetValue() ;
