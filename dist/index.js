...
var Promise = __webpack_require__(748);
...
var NodeGit = __webpack_require__(863);
...
module.exports = require(__webpack_require__.ab + "build/Release/nodegit.node")
...
Object.defineProperty(exports, "__esModule", { value: true });
const nodegit_1 = __webpack_require__(863);
function findWrapperJars(gitRepoPath) {
    return __awaiter(this, void 0, void 0, function* () {
        const repo = yield nodegit_1.Repository.open(gitRepoPath);
...
const Promise = __webpack_require__(204);
const args = __webpack_require__(141);
...
var asap = __webpack_require__(550);
...
eval("require")("../build/Debug/nodegit.node");
...
var promisify = __webpack_require__(724);
var rawApi;

// Attempt to load the production release first, if it fails fall back to the
// debug release.
try {
  rawApi = __webpack_require__(201);
} catch (ex) {
  ...
  rawApi = __webpack_require__(839);
}
...
// Set version.
exports.version = __webpack_require__(126).version;
...
var rawAsap = __webpack_require__(550);
var freeTasks = [];
